...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/CloudBees-CI-ICDC/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>CloudBees-CI-ICDC</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>CloudBees-CI-ICDC</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/CloudBees-CI-ICDC/pipeline-template-catalog.git</repositoryUrl>
              <traits>
